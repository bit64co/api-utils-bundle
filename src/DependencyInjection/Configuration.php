		...
		$node
			->children()
				->arrayNode('exceptions')
					...
					->children()
						->booleanNode('error_response_debug_headers')
							->defaultValue(false)
							->info('Include exception debug headers in error responses')
						->end()
						->booleanNode('json_error_responses')
							->defaultValue(true)
							->info('Convert exceptions into JsonResponses')
						->end()
					->end()
				->end()
